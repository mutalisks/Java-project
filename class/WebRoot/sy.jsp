...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   検索:  タイトル：<input name="biaoti" type="text" id="biaoti" style='border:solid 1px #000000; color:#666666' size="12" />  分類：<input name="fenlei" type="text" id="fenlei" style='border:solid 1px #000000; color:#666666' size="12" />  追加する人：<input name="tianjiaren" type="text" id="tianjiaren" style='border:solid 1px #000000; color:#666666' size="12" />
...
if(request.getParameter("tianjiaren")=="" ||request.getParameter("tianjiaren")==null ){}else{sql=sql+" and tianjiaren like '%"+request.getParameter("tianjiaren")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"> <a href="gonggaoxinxi_detail.jsp?id=<%=map.get("id")%>">詳細</a> </td>
  </tr>
  	<%
  }
   %>
