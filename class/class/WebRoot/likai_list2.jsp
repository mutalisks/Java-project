...
if(request.getParameter("xuehao")=="" ||request.getParameter("xuehao")==null ){}else{sql=sql+" and xuehao like '%"+request.getParameter("xuehao")+"%'";}
 ...
 <td><%=map.get("xingming") %></td>
    ...
    <td width="60" align="center"><a href="likai_updt.jsp?id=<%=map.get("id")%>">修正する</a>  <a href="likai_list2.jsp?scid=<%=map.get("id") %>" onclick="return confirm('本当に削除しますか？')">削除する</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
