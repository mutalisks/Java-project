...
if(request.getParameter("zhuangtai")=="" ||request.getParameter("zhuangtai")==null ){}else{sql=sql+" and zhuangtai like '%"+request.getParameter("zhuangtai")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="jiaoshixinxi_updt.jsp?id=<%=map.get("id")%>">修正する</a>  <a href="jiaoshixinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('Do you confirm？')">削除する</a> <a href="jiaoshixinxi_detail.jsp?id=<%=map.get("id")%>">詳細</a> </td>
  </tr>
  	<%
  }
   %>
