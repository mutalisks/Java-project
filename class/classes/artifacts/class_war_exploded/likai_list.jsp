...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="検索" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="書き出す" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='likai_listxls.jsp';" />
</form>
...
if(request.getParameter("xuehao")=="" ||request.getParameter("xuehao")==null ){}else{sql=sql+" and xuehao like '%"+request.getParameter("xuehao")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="likai_updt.jsp?id=<%=map.get("id")%>">修正する</a>  <a href="likai_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('本当に削除しますか？')">削除する</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
