...
new CommDAO().update(request,response,"quxiao",ext,true,false,""); 
HashMap mmm = new CommDAO().getmap(id,"quxiao"); 

%>
  <form  action="quxiao_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  キャンセルを修正する:
  <br><br>
