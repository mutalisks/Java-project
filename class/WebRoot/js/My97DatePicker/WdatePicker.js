let $dp, WdatePicker;(function(){
	const $ = {
		$langList: [{name: "en", charset: "gb2312"}, {name: "zh-cn", charset: "gb2312"}, {
			name: "zh-tw",
			charset: "gb2312"
		}],
		$skinList: [
